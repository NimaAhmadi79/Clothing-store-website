...
<head>
    ...
    <title>Clothes shopping/Register</title>
...
<div class="wrapper">
    ...
    <div style="background-color: black; border-radius: 2em;">
        ...
        <h1 style="color: #356; font-size: 50px; margin-left: 180px; margin-top: 50px"> Clothes shopping</h1>

        <form id="bt" action="Register" method="post" ">
            <label style="color: #356; font-size: 20px; margin-left: 135px;" >Email</label>
            <input  class="input" name="email" type="text"  placeholder="Your mail.." style="margin-left: 15px; margin-top: 35px"  id="e">
            <br>
            <label style="color: #356; font-size: 20px; margin-left: 53px">Phone number</label>
            <input  class="input" name="phone" type="text"  placeholder="0910 *** ** **" style="margin-left: 15px; margin-top: 30px"  >
            <br>
            <label style="color: #356; font-size: 20px; margin-left: 97px" >Password</label>
            <input  class="input" name="pass" type="password"  placeholder="*******" style="margin-left: 15px; margin-top: 30px" id="p1">
            <br>
            <label style="color: #356; font-size: 20px; margin-left: 30px" >Repeat password</label>
            <input  class="input" type="password"  placeholder="*******" style="margin-left: 15px; margin-top: 30px" id="p2">

<%--            <input type="submit" class="submit"  onclick="email_reg() , cp() , p()" >--%>
            <button  class="submit" onmouseover="email_reg() , cp() , p(),onsubmit()">Register</button>>
        </form>
        <div style="color: #356; margin-left: 280px; margin-top: 15px;">
            do you have account?<a href="Login.jsp" style="color: #356">Login</a>
        </div>

<%--        <label style="color: #356; font-size: 20px; margin-left: 135px;" >Email</label>--%>
<%--        <input  class="input" type="text"  placeholder="Your mail.." style="margin-left: 15px; margin-top: 35px"  id="e">--%>
<%--        <br>--%>
<%--        <label style="color: #356; font-size: 20px; margin-left: 53px">Phone number</label>--%>
<%--        <input  class="input" type="text"  placeholder="0910 *** ** **" style="margin-left: 15px; margin-top: 30px" >--%>
<%--        <br>--%>
<%--        <label style="color: #356; font-size: 20px; margin-left: 97px" >Password</label>--%>
<%--        <input  class="input" type="password"  placeholder="*******" style="margin-left: 15px; margin-top: 30px" id="p1">--%>
<%--        <br>--%>
<%--        <label style="color: #356; font-size: 20px; margin-left: 30px" >Repeat password</label>--%>
<%--        <input  class="input" type="password"  placeholder="*******" style="margin-left: 15px; margin-top: 30px" id="p2">--%>

<%--        <button class="submit" onclick="email_reg() , cp() , p()">Register</button>>--%>
<%--        <div style="color: #356; margin-left: 280px; margin-top: 15px;">--%>
<%--            do you have account?<a href="login.html" style="color: #356">Login</a>--%>
<%--        </div>--%>
